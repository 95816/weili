...
<head>
    ...
    <link rel="stylesheet" href="/statics/jump/msgbox.css"/>
    <link rel="stylesheet" href="/statics/jump/sweetalert.css"/>
...
<div class="system-message">
    ...
    <span class="sa-line sa-right"></span>
        ...
        <p style="display: block;"><?php echo(strip_tags($jump['msg']));?>,正在跳转，等待时间： <b id="wait"><?php echo($jump['wait']);?></b></p>
        <fieldset>
            ...
            <a id="href" href="<?php echo($jump['url']);?>"> <button class="confirm" tabindex="1" style="display: inline-block; box-shadow: rgba(174, 222, 244, 0.8) 0px 0px 2px, rgba(0, 0, 0, 0.0470588) 0px 0px 0px 1px inset; background-color: #009688;">立即跳转</button></a>
        </div></div>
