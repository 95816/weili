...
<section class="Hui-article-box">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 产品管理 <span class="c-gray en">&gt;</span> 产品分类 <a
        ...
        <article class="cl pd-20">
            <table class="table">
                <tr>
                    ...
                    <td class="va-t">
                        <iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO width=100% height=390px SRC="/admin/category/create"></iframe>
                    </td>
                </tr>
            </table>
        </article>
        ...
        callback: {
            beforeClick: function (treeId, treeNode) {
                ...
                if (treeNode.isParent) {
                    ...
                    $('#testIframe').attr('src', '/admin/category/edit/id/' + treeNode.id);
